package com.seapip.thomas.kai.provider;
 ...
 */
public class SimpleDateProviderService extends ComplicationProviderService {

    private static final String TAG = "SimpleDateProvider";

package com.seapip.thomas.kai.utility;
...
import com.seapip.thomas.kai.module.AnalogClockModule;
import com.seapip.thomas.kai.module.ComplicationModule;
import com.seapip.thomas.kai.module.Module;
import com.seapip.thomas.kai.module.UtilityTicksModule;
...
public class WatchFaceService extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        private UtilityTicksModule mUtilityTicksModule;
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            int style = mPrefs.getInt("settings_utility_style", 0);
            ...
            mUtilityTicksModule = new UtilityTicksModule(style);
            ...
            int color = mPrefs.getInt("settings_utility_color_value", Color.parseColor("#00BCD4"));
            int accentColor = mPrefs.getInt("settings_utility_accent_color_value",
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            switch (SETTINGS_MODE) {
                ...
                case 3:
                    setBounds();
                    int style = mPrefs.getInt("settings_utility_style", 0);
                    int color = mPrefs.getInt("settings_utility_color_value",
                            Color.parseColor("#00BCD4"));
                    int accentColor = mPrefs.getInt("settings_utility_accent_color_value",

package com.seapip.thomas.kai.motion;
...
import com.seapip.thomas.kai.settings.SettingsAdapter;
import com.seapip.thomas.kai.settings.SettingsFinish;
import com.seapip.thomas.kai.settings.SettingsOverlay;
import com.seapip.thomas.kai.settings.SettingsPage;
import com.seapip.thomas.kai.settings.SettingsRow;

import java.util.ArrayList;
import java.util.concurrent.Executor;

public class SettingsActivity extends com.seapip.thomas.kai.settings.SettingsActivity {
                    ...
                    public void run() {
                        ...
                        switch (scene) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                backgroundOverlay.setTitle("Butterfly");
                                break;
                            case 4:
                                backgroundOverlay.setTitle("Water");
                                break;
                        }
